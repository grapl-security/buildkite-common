...
test_add_artifacts_with_artifacts() {
    add_artifacts cicd/production '{"app1":"v1.0.0","app2":"v1.2.0","has_spaces":"yep i do"}'
...
pulumi config set --path artifacts.has_spaces "yep i do" --cwd=pulumi/cicd --stack=grapl/cicd/production
EOF
    )
